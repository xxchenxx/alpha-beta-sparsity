...
from utils import train_with_imagenet_mean_teacher
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # model_teacher = nn.SyncBatchNorm.convert_sync_batchnorm(model_teacher, process_group)
    ...
    if args.gpu is not None:
        ...
        model_teacher = torch.nn.DataParallel(model_teacher)#, find_unused_parameters=True)
